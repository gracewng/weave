...
<p>Subtotal $79.70 · Tax $5.18 · Shipping FREE · Total $84.88</p><p>Unsubscribe · Privacy Policy</p></body></html>`,
    expected: { is_clothing_order: true, retailer: 'Uniqlo', order_date: '2026-08-14', items: [
      { name: 'U Crew Neck Short-Sleeve T-Shirt', brand: 'Uniqlo', size: 'M', color: 'Black', price_cents: 1490, quantity: 2, image_index: 0 },
      { name: 'Pleated Wide Pants', brand: 'Uniqlo', size: '30', color: 'Navy', price_cents: 4990, quantity: 1, image_index: 1 } ] },
  },
  {
    ...
    expected: { is_clothing_order: true, retailer: 'Everlane', order_date: '2026-07-02', items: [
      { name: 'The Linen Relaxed Shirt', brand: 'Everlane', size: 'S', color: 'Bone', price_cents: 7800, quantity: 1, image_index: 0 } ] },
  },
  {
    ...
    expected: { is_clothing_order: false, retailer: 'Nike', order_date: '2026-06-20', items: [] },
  },
  {
...
<p>Order Total: $130.09</p></body></html>`,
    expected: { is_clothing_order: true, retailer: 'Amazon', order_date: '2026-05-11', items: [
      { name: "Levi's Original Trucker Jacket", brand: "Levi's", size: 'M', color: 'Medium Wash', price_cents: 6950, quantity: 1, image_index: 0 },
      { name: 'Bombas Ankle Socks 4-Pack', brand: 'Bombas', size: 'M', color: null, price_cents: 4760, quantity: 1, image_index: 2 } ] },
  },
  {
    ...
    expected: { is_clothing_order: true, retailer: 'Aritzia', order_date: '2026-09-03', items: [
      { name: 'Wilfred Slip Midi Dress', brand: 'Wilfred', size: '4', color: 'Black', price_cents: 14800, quantity: 1, image_index: 0 } ] },
  },
];
