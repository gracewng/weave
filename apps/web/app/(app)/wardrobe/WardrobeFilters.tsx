...
export function WardrobeFilters({ q, sort, returnable, view, count }: { q: string; sort: Sort; returnable: boolean; view: View; count: number }) {
  ...
  const seg = (on: boolean) => `chip !py-2 !px-3.5 !text-[11px] ${on ? '' : 'bg-transparent hover:bg-mist'}`;
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <div className="flex items-center gap-1 rounded-full border border-dust p-1" role="group" aria-label="Sort">
      ...
      <div className="ml-auto flex items-center gap-1 rounded-full border border-dust p-1" role="group" aria-label="Layout">
