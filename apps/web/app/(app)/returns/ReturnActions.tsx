...
export function ReturnActions({ itemId, name, priceCents, status, compact = false }: { itemId: string; name: string; priceCents: number | null; status: 'owned' | 'returning'; compact?: boolean }) {
  ...
  return (
    <div className="mt-3 flex flex-wrap items-center gap-2">
      ...
      {(!compact || status === 'returning') && <span className="flex items-center gap-1.5">
